...
public class KneeSection extends CommonSection {
	...
	private static final float BOTTOM_RECTANGLE_DIMENSION = 265;
	...
	double[] previousKneeFunctionValues;
	double[] minKneeFunctionValues;
	double[] maxKneeFunctionValues;
	...
	public KneeSection(PdfContentByte canvas, int[] kneeFunctionValues,
			double[] previousKneeFunctionValues,
			double[] minKneeFunctionValues, double[] maxKneeFunctionValues)
			throws Exception {
