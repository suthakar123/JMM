...
% ---  #1 --- %
function varargout = LearningGUIShapelet_v2(varargin)
    ...
    % Last Modified by GUIDE v2.5 14-Jul-2015 16:51:26
...
function DisplayConfusionMatrix(handles)
    ...
    if (~isempty(handles.tree) && ~isempty(handles.expectedMatrix) && ...
        ...
        %figure;
       % newPredictMatrix = [];
        %for i= 1:length(handles.predictedMatrix)-1
            newPredictMatrix(i) = handles.predictedMatrix(i);
            
        end
        plotconfusion(handles.expectedMatrix, handles.predictedMatrix);
        %plotconfusion(handles.expectedMatrix, newPredictedMatrix);
    %end
end
