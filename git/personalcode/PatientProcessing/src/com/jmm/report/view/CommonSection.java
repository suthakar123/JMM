...
public class CommonSection {
	...
	BaseColor LIGHT_RED = new BaseColor(0xEE, 0x3B, 0x3B);
	BaseColor ROYAL_BLUE = new BaseColor(0x48, 0x76, 0xFF);
	BaseColor STEEL_BLUE = new BaseColor(0x8E, 0x38, 0x8E);
	BaseColor KHAKI = new BaseColor(0xCD, 0xAD, 0x00);
	BaseColor OLIVE = new BaseColor(0x55, 0x6B, 0x2F);
	BaseColor activityColor[] = { ROYAL_BLUE, LIGHT_RED };
	BaseColor ringColors[] = { ROYAL_BLUE, OLIVE,
			BaseColor.MAGENTA, LIGHT_RED, KHAKI, STEEL_BLUE,
			BaseColor.ORANGE , BaseColor.PINK, BaseColor.LIGHT_GRAY};
	...
	Font imageTextFont = new Font(FontFamily.HELVETICA, 7, 0, BaseColor.BLACK);
	...
	Font ringTextFont = new Font(FontFamily.HELVETICA, 8, 0,
			BaseColor.WHITE);
	...
	//protected static final String LOGO_NAME = "resources/JM_logo_final.bmp";
	protected static final String LOGO_NAME = "JM_logo_final.bmp";
